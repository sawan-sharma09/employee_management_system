    ...
    "paths": {
        "/": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Gin Application working",
                        "schema": {
                            "type": "string"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/util.Employee"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Employee created with ID: X",
                        "schema": {
                            "type": "string"
                        }
                    },
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/app_errors.ErrorTemplate"
                        }
                    },
                    "500": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/util.Credentials"
                        }
                    }
                ],
                "responses": {
